...
ReplaceDialog::ReplaceDialog(QWidget *parent)
    :QDialog(parent)
{
    find_label          = new QLabel(tr("Find Content"));
    replace_label       = new QLabel(tr("Replace with"));
    find_str            = new QLineEdit();
    replace_str         = new QLineEdit();
    find_next_button    = new QPushButton(tr("Find the next"));
    replaced_one_button = new QPushButton(tr("Replace"));
    replaced_all_button = new QPushButton(tr("Replace All"));
    cancle_button       = new QPushButton(tr("Cancel"));
    ignore_flag         = new QCheckBox(tr("Case-sensitive"));
